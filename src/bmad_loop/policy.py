...
[adapter]
name = "claude"              # any profile bmad-loop can resolve: bundled (claude, codex, gemini, copilot, antigravity, opencode-http) or registered by a co-installed adapter package (see docs/cli-adapters.md)
